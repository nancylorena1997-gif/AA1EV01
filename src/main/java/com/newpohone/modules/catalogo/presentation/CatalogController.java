...
import com.newpohone.modules.catalogo.infrastructure.ReviewRepository;
import com.newpohone.modules.favoritos.infrastructure.FavoriteRepository;
import com.newpohone.shared.presentation.RequestParsers;
...
public class CatalogController {
    ...
    public String catalog(@RequestParam(required = false) String q,
            ...
            HttpSession session,
            Model model) {
        Integer categoryId = RequestParsers.parseInteger(categoria);
        Double minPrice = RequestParsers.parseDouble(min);
        Double maxPrice = RequestParsers.parseDouble(max);
