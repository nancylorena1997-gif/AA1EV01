package com.newpohone.modules.crud.presentation;

import com.newpohone.modules.crud.infrastructure.GenericModuleRepository;
import com.newpohone.modules.crud.domain.ModuleDefinition;
import com.newpohone.modules.crud.domain.ModuleRegistry;
import com.newpohone.modules.autenticacion.domain.PasswordHasher;
...
public class ModuleController {
    ...
    public String list(@PathVariable String key,
        ...
        String fromDate = TextNormalizer.blankToNull(desde);
        String toDate = TextNormalizer.blankToNull(hasta);
        String reportType = TextNormalizer.blankToNull(tipo);
